...
// ─── Pagination (mirrors AdminDashboard pattern) ──────────────────────────────
        ...
        <>
          <div style={styles.tableWrapper}>
            <table style={styles.table}>
              <thead>
                <tr>
                  {['Photo', 'Student ID', 'Username', 'Name', 'Department', 'Status'].map(h => (
...
const styles = {
  ...
  primaryBtn:   { padding: '8px 16px', backgroundColor: '#1a1a2e', color: '#fff', border: 'none', borderRadius: '8px', cursor: 'pointer', fontSize: '13px', whiteSpace: 'nowrap' },
